...
<div class="rightinfo">
    ...
    <div class="tools">
        <ul class="toolbar">
            ...
            <li class="click"><a href="javascript:form1.submit();"><span><img src="images/t03.png" />
            </span>删除</a></li>
        </ul>
    </div>
    ...
    <table class="tablelist">
        ...
        <tr>
            ...
            <td><a href="<c:url value="/adminCategoryServlet?action=updatebefore&id=${item.categoryid}"/> " class="tablelink"
                ...
                <a href="javascript:if (confirm('确定要删除嘛？')) window.location.href='<c:url value="/adminCategoryServlet?action=delete&id=${item.categoryid}&currentPage=${page.currentPage}"/> ';" class="click"> 删除 </a>
            </td>
        </tr>
        </c:forEach>
        </tbody>
    ...
    <div class="pagin">
        <div class="message">
            共<i class="blue">${page.totalSize }</i>条记录，当前显示第&nbsp;<i class="blue">${page.currentPage }&nbsp;</i>页/共${page.totalPage}页
        </div>
        ...
        <ul class="paginList">
            ...
            <c:forEach var="i" begin="${page.start}" end="${page.end}">
                <c:choose>
                    ...
                    <c:otherwise>
                        ...
                        <c:url value="/adminCategoryServlet?action=findAll&currentPage=${i}"/>"> ${i}</a>
                        </li>
                    </c:otherwise>
                </c:choose>
            </c:forEach>
            ...
            <c:choose>
                <c:when test="${page.currentPage == page.totalPage}"></li>
                    <li class="paginItem">
                     <a href=""><span class="pagenxt"></span>
                    </a>
                    </li>
                </c:when>
                <c:otherwise>
